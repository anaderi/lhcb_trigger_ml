...
basedir = './data/raspodela2/raspodele/'
marker = 20
size = 0.5
colour = 1
...
for entry in filestoplot :
  ...
  filestoplot[entry]['graph'].GetXaxis().SetLabelSize(0.075)
  filestoplot[entry]['graph'].GetXaxis().SetLabelOffset(0.015)
  filestoplot[entry]['graph'].GetXaxis().SetTitleSize(0.10)
  filestoplot[entry]['graph'].GetXaxis().SetTitleOffset(0.6)
  filestoplot[entry]['graph'].GetYaxis().SetTitleSize(0.10)
  filestoplot[entry]['graph'].GetYaxis().SetLabelSize(0.075)
  filestoplot[entry]['graph'].GetYaxis().SetTitleOffset(0.65)
...
for entry in filestoplot :
  ...
  filestoplot[entry]['graph'].GetYaxis().SetRangeUser(-10.5,0.5)  
...
c1.SaveAs('PitDistributions.pdf')
c1.SaveAs('PitDistributions.png')
